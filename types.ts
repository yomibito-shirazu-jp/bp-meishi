...
export enum AppState {
  ...
  TOOL_NEWSLETTER = 'TOOL_NEWSLETTER',
  TOOL_MANUSCRIPT = 'TOOL_MANUSCRIPT',
  TOOL_REPLACE = 'TOOL_REPLACE',
  TOOL_PROOFREAD = 'TOOL_PROOFREAD',
  TOOL_GROUNDING = 'TOOL_GROUNDING',
  TOOL_REPRINT = 'TOOL_REPRINT',
  TOOL_BIZPLAN = 'TOOL_BIZPLAN',
  // 画像・メディア
  TOOL_IMG_GEN = 'TOOL_IMG_GEN',
  TOOL_IMG_RETOUCH = 'TOOL_IMG_RETOUCH',
  TOOL_IMG_EDIT = 'TOOL_IMG_EDIT',
  TOOL_IMG_BGREMOVE = 'TOOL_IMG_BGREMOVE',
  TOOL_MEDIA_CONVERT = 'TOOL_MEDIA_CONVERT',
  TOOL_IMG_UPSCALE = 'TOOL_IMG_UPSCALE',
  TOOL_OCR = 'TOOL_OCR',
}
