...
export enum AppState {
  ...
  // 神ツール軍 (7 Steps)
  TOOL_STEP1_RECEIVE = 'TOOL_STEP1_RECEIVE',
  TOOL_STEP2_NORMALIZE = 'TOOL_STEP2_NORMALIZE',
  TOOL_STEP3_MAP = 'TOOL_STEP3_MAP',
  TOOL_STEP4_RULES = 'TOOL_STEP4_RULES',
  TOOL_STEP5_GENERATE = 'TOOL_STEP5_GENERATE',
  TOOL_STEP6_QA = 'TOOL_STEP6_QA',
  TOOL_STEP7_EXPORT = 'TOOL_STEP7_EXPORT',
  // AIインデザイン
